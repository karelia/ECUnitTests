...
- (void)assertString:(NSString*)string1 matchesString:(NSString*)string2
{
    ...
    XCTAssertTrue(length1 == length2, @"string lengths don't match: was %ld expected %ld \n\nwas:\n%@\n\nexpected:\n%@", length1, length2, string1, string2);
    ...
    for (NSUInteger n = 0; n < safeLength; ++n)
    {
        ...
        XCTAssertTrue(c1 == c2, @"Comparison failed at character %ld (was 0x%x '%c' expected 0x%x '%c') of:\n\n%@", n, c1, c1, c2, c2, string1);
        if (c1 != c2)
        {
